...
const Booking = () => {
  ...
  const handleSubmit = (event) => {
    ...
    if (adults <= 0) {
      setErrors(prev => ({ ...prev, adults: 'Please select at least one adult' }));
      hasError = true;
    }
...
const totalPrice = getPrice(selectedRoom, totalDays);
  ...
  return (
    <div className="booking-container">
      ...
      >
        <header className="booking-header" style={{ paddingTop: '50px', paddingLeft: '100px' }}>
...
>
  <option value="Standard Room">{padOptionText('Standard Room', 40)}₹2000</option>
  <option value="Deluxe Room">{padOptionText('Deluxe Room', 40)}₹3000</option>
  <option value="Premier Room">{padOptionText('Premier Room', 40)}₹4000</option>
  <option value="Family Suite">{padOptionText('Family Suite', 40)}₹5000</option>
  <option value="Luxury Suite">{padOptionText('Luxury Suite', 40)}₹8000</option>
  <option value="Presidential Suite">{padOptionText('Presidential Suite', 40)}₹10000</option>
</select>
      </div>
